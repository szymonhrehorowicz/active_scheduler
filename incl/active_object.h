...
template <typename RouterType> class Object : public Object_Interface {
  static_assert(std::is_base_of_v<Router_Interface, RouterType>,
                "RouterType must inherit from Router_Interface");

public:
  Object(uint32_t priority, etl::message_router_id_t router_id,
         etl::imessage_bus &public_bus)
      : Object_Interface(priority), m_router(router_id, *this),
  ...
  Router_Interface &get_internal_router() override { return m_router; }
